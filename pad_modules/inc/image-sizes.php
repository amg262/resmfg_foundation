...
function pad_image_sizes() {
    ...
    add_image_size( 'logo', 175, 114, true ); // (cropped)
    ...
    add_image_size( 'bucket-image', 400, 300, true ); // (cropped)
    add_image_size( 'bucket-image-2', 275, 180, true ); // (cropped)
    add_image_size( 'icon-128', 128, 128, true ); // (cropped)
    add_image_size( 'small-medium', 250, 175, true ); // (cropped)
    add_image_size( 'slider-image', 650, 400, true ); // (cropped)
